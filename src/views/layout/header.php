...
<head>
    ...
    <link rel="stylesheet" href="<?= asset_url('src/assets/css/main.css') ?>">
    <link rel="stylesheet" href="<?= asset_url('src/assets/css/auth-modal.css') ?>">
    <link rel="stylesheet" href="<?= asset_url('src/assets/css/footer.css') ?>">
    <link rel="stylesheet" href="<?= asset_url('src/assets/css/animations.css') ?>">
    <?php if (isset($dashboard_css) && $dashboard_css === 'admin'): ?>
        <link rel="stylesheet" href="<?= asset_url('src/assets/css/dashboard_admin.css') ?>">
    <?php elseif (isset($dashboard_css) && $dashboard_css === 'buyer'): ?>
        <link rel="stylesheet" href="<?= asset_url('src/assets/css/dashboard_buyer.css') ?>">
    <?php elseif (isset($dashboard_css) && $dashboard_css === 'seller'): ?>
        <link rel="stylesheet" href="<?= asset_url('src/assets/css/dashboard_seller.css') ?>">
    <?php endif; ?>
</head>
<?php
